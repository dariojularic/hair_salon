export const translations = {
  hr: {
    ...
    "about-p":
      "Od 20XX. godine kreiramo frizure koje pričaju tvoju priču. Moderan prostor u srcu grada, tim iskusnih stilista i samo premium proizvodi. Nije samo šišanje – to je ritual ljepote.",
    ...
    "gallery-p":
      "Pronađi inspiraciju, donesi ideju, a mi ćemo je pretvoriti u tvoju frizuru.",
    "reviews-header": "RECENZIJE",
    "reviews-h3": "STO NASI KLIJENTI MISLE O NAMA",
  ...
  en: {
    ...
    "about-p":
      "Since 20XX, we have been creating hairstyles that tell your story. A modern space in the heart of the city, an experienced team of stylists, and only premium products. It's not just a haircut – it's a beauty ritual.",
    ...
    "gallery-p":
      "Find inspiration, bring an idea, and we will turn it into your hairstyle.",
    "reviews-header": "REVIEWS",
    "reviews-h3": "WHAT OUR CUSTOMERS THINK ABOUT US",
  ...
  de: {
    ...
    "about-p":
      "Seit 20XX kreieren wir Frisuren, die Ihre Geschichte erzählen. Ein moderner Raum im Herzen der Stadt, ein erfahrenes Team von Stylisten und nur Premium-Produkte. Es ist nicht nur ein Haarschnitt – es ist ein Schönheitsritual.",
    ...
    "gallery-p":
      "Lassen Sie sich inspirieren, bringen Sie eine Idee mit, und wir machen daraus Ihre Frisur.",
    "reviews-header": "BEWERTUNGEN",
    "reviews-h3": "WAS UNSERE KUNDEN ÜBER UNS DENKEN",
